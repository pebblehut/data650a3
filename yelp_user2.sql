...
insert into yelp_user (yelping_since,review_count,fans,
average_stars,name,user_id,votes_cool,votes_funny,votes_useful)
...
select user_id,name,yelping_since,review_count,fans,average_stars
from yelp_user;

select user_id,votes_cool,votes_funny,votes_useful 
from yelp_user;
